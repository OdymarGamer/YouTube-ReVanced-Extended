...
for table_name in $(toml_get_table_names); do
	...
	app_args[app_name]=$(toml_get "$t" app-name | sed "s/'/'\\\\''/g") || app_args[app_name]=$table_name
...
log "\n[YouTube-ReVanced-Extended](https://github.com/OdymarGamer/YouTube-ReVanced-Extended)\n"
